...
namespace WindowsGSM.Plugins
{
    public class ArmaReforger : SteamCMDAgent
    {
        ...
        {
            name = "WGSM.ArmaReforger", // WGSM.XXXX
            author = "raziel7893",
            description = "WGSM plugin for supporting ArmaReforger Dedicated Server",
            version = "1.0.0",
            url = "https://github.com/Raziel7893/WGSM.ArmaReforger", // Github repository link (Best practice) TODO
