...
namespace WindowsGSM.Plugins
{
    public class BoB : SteamCMDAgent
    {
        ...
        {
            name = "WGSM.BoB", // WGSM.XXXX
            author = "kessef",
            description = "WGSM plugin for supporting Beasts of Bermuda Dedicated Server",
            version = "1.0",
            url = "https://github.com/dkdue/WGSM.BoB", // Github repository link (Best practice)
        ...
        public static async Task<bool> DownloadGameServerConfig(string fileSource, string filePath)
        {
            ...
            try
            {
                ...
                {
                    await webClient.DownloadFileTaskAsync($"https://raw.githubusercontent.com/dkdue/WGSM-Configs/main/BoB/Game.ini", filePath);
                }
            }
            catch (Exception e)
            {
