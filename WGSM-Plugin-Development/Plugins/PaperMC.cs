...
namespace WGSM.Plugins
{
    public class PaperMC
    {
        ...
        {
            name = "WGSM.PaperMC", // WGSM.XXXX
            author = "BattlefieldDuck",
            description = "🧩 WGSM plugin for supporting Minecraft: Paper Server",
            version = "1.0",
            url = "https://github.com/BattlefieldDuck/WGSM.PaperMC", // Github repository link (Best practice)
