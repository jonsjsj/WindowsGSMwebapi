...
namespace WindowsGSM.Plugins
{
    public class Hurtworld : SteamCMDAgent
    {
        ...
        {
            name = "WGSM.Hurtworld", // WGSM.XXXX
            author = "raziel7893",
            description = "WGSM plugin for supporting Hurtworld Dedicated Server",
            version = "1.0.0",
            url = "https://github.com/Raziel7893/WGSM.Hurtworld", // Github repository link (Best practice) TODO
