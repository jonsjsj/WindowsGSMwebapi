...
namespace WindowsGSM.Plugins
{
    public class ArkSurvivalAscended : SteamCMDAgent
    {
        ...
        {
            name = "WGSM.ArkSurvivalAscended", // WGSM.XXXX
            author = "sh1ny",
            description = "WGSM plugin for supporting ArkSurvivalAscended Dedicated Server",
            version = "1.21",
            url = "https://github.com/sh1ny/WGSM.ArkSurvivalAscended/", // Github repository link (Best practice)
        ...
        public int PortIncrements = 2; // This tells WGSM how many ports should skip after installation
