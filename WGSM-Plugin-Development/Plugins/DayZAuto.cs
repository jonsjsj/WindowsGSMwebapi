...
namespace WGSM.Plugins
{
    ...
    {       
        ...
        {
            name = "WGSM.DayZAuto", // WGSM.XXXX
            author = "raziel7893",
            description = "WGSM plugin for supporting DayZ Dedicated Server with automatic ModUpdates",
            version = "1.0.0",
            url = "https://github.com/raziel7893/WGSM.DayZAuto", // Github repository link (Best practice)
