...
namespace WGSM.GameServer
{
    ...
    /// when changing a map to a custom map, the redirect output is stucked in p.OutputDataReceived and the whole WGSM and Mordhau freeze.
    ...
    /// Although this may not cool as the server output is not within WGSM, but that is the only choice to keep Mordhau stable.
    /// 
    ...
    class MORDHAU : Engine.UnrealEngine
    {
        ...
        {    
            ...
            //Edit WGSM.cfg
            string configFile = Functions.ServerPath.GetServersConfigs(_serverData.ServerID, "WGSM.cfg");
