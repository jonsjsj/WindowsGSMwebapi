...
namespace WindowsGSM.GameServer
{
    ...
    class SE
    {
        ...
        {
            //Download SpaceEngineersDedicated-WGSM.bat
            string batPath = Functions.ServerPath.GetServersServerFiles(_serverData.ServerID, @"DedicatedServer64\SpaceEngineersDedicated-WGSM.bat");
