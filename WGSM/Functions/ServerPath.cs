...
namespace WindowsGSM.Functions
{
    public static class ServerPath
    {
        ...
        /// <summary>
        /// Get WGSM.exe parent directory path. Example: "C://WGSM/"
        /// </summary>
        ...
        /// <summary>
        /// Get backup directory path with serverId. Example: "C://WGSM/backups/1/"
        /// </summary>
        ...
        /// <summary>
        /// Get bin directory path. Example: "C://WGSM/bin/"
        /// </summary>
        /// <param name="path1"></param>
        /// <param name="path2"></param>
        /// <param name="path3"></param>
        ...
        /// <summary>
        /// Get log directory path. Example: "C://WGSM/logs/"
        /// </summary>
        /// <param name="path1"></param>
        /// <param name="path2"></param>
        /// <param name="path3"></param>
        ...
        /// <summary>
        /// Get plugins directory path. Example: "C://WGSM/plugins/"
        /// </summary>
        /// <param name="path1"></param>
        /// <param name="path2"></param>
        /// <param name="path3"></param>
        ...
        /// <summary>
        /// Get servers directory path with serverId. Example: "C://WGSM/servers/1/"
        /// </summary>
        /// <param name="serverId"></param>
        /// <param name="path1"></param>
        /// <param name="path2"></param>
        ...
        /// <summary>
        /// Get servers configs directory path with serverId. Example: "C://WGSM/servers/1/configs/"
        /// </summary>
        /// <param name="serverId"></param>
        /// <param name="path1"></param>
        /// <param name="path2"></param>
        ...
        /// <summary>
        /// Get servers cache directory path with serverId. Example: "C://WGSM/servers/1/cache/"
        /// </summary>
        /// <param name="serverId"></param>
        /// <param name="path1"></param>
        /// <param name="path2"></param>
        ...
        /// <summary>
        /// Get serverfiles directory path with serverId. Example: "C://WGSM/servers/1/serverfiles/"
        /// </summary>
        /// <param name="serverId"></param>
        /// <param name="path1"></param>
        /// <param name="path2"></param>
