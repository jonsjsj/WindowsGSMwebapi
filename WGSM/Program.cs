...
namespace WindowsGSM
{
    public class Program
    {
        ...
        {
            // Due to a weird error, MahApps.Metro.dll cannot be embed inside WGSM.exe,
            // therefore, MahApps.Metro.dll is stored in Resources, and copy the file to the WGSM directory.
