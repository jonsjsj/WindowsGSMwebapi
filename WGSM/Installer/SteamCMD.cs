    ...
    public class SteamCMD
    {
        ...
        public void CreateUserDataTxtIfNotExist()
        {
            if (!File.Exists(_userDataPath))
            {
                ...
                {
                    textwriter.WriteLine("// For security and compatibility reasons, WGSM suggests you to create a new steam account.");
                    textwriter.WriteLine("// More info: (https://docs.wgsm.com/installer/steamcmd)");
